...
@section('content')
    <div class="container mx-auto px-4 pt-16">
        <div class="latest-movies">
            <h2 class="uppercase tracking-wider text-orange-300 text-lg font-semibold">Latest Movies</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/bloodshot.jpg" alt="bloodshot" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300">Bloodshot</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            {{-- star svg file start --}}
                                    <svg class="fill-content text-orange-500 w-4" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/foret.jpg" alt="foret" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300">Foret</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            {{-- star svg file start --}}
                                    <svg class="fill-content text-orange-500 w-4" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;" xml:space="preserve">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/FantasyIsland.jpg" alt="FantasyIsland" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300">Fantasy Island</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            {{-- star svg file start --}}
                                    <svg class="fill-content text-orange-500 w-4" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;" xml:space="preserve">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/birdsOfPrey.jpg" alt="birdsOfPrey" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300">Birds Of Prey</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            {{-- star svg file start --}}
                                    <svg class="fill-content text-orange-500 w-4" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;" xml:space="preserve">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/mulan.jpg" alt="mulan" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300">Mulan</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            {{-- star svg file start --}}
                                    <svg class="fill-content text-orange-500 w-4" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;" xml:space="preserve">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/starWar.jpg" alt="starWar" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300">Star War</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            {{-- star svg file start --}}
                                    <svg class="fill-content text-orange-500 w-4" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;" xml:space="preserve">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/underWater.jpeg" alt="underWater" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300">Under Water</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            {{-- star svg file start --}}
                                    <svg class="fill-content text-orange-500 w-4" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;" xml:space="preserve">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/theWarWithGrandPa.jpg" alt="theWarWithGrandPa" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray-300">The War With GrandPa</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            {{-- star svg file start --}}
                                    <svg class="fill-content text-orange-500 w-4" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512.002 512.002;" xml:space="preserve">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/avatarMv.jpg" alt="avatarMv" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
        ...
        <div class="watch-movies mt-20">
            <h2 class="uppercase tracking-wider text-orange-300 text-lg font-semibold">Watch Movies</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/bloodshot.jpg" alt="bloodshot" class="hover:opacity-75 transition ease-in-out duration-150">
        ...
        <div class="free-movies mt-20">
            <h2 class="uppercase tracking-wider text-orange-300 text-lg font-semibold">Free Movies</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/bloodshot.jpg" alt="bloodshot" class="hover:opacity-75 transition ease-in-out duration-150">
